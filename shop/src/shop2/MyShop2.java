...
public class MyShop2 implements IShop{
	...
	public void genUser() {		
		...
		System.out.println(dao.insert(userId, name, payNo)?"user 추가 성공":"user 추가 실패");
...
//		products[3] = new SmartTv("LG Smart Tv", 1200000, "Full HD");
	...
	public void start() {
		...
		for (int i = 0; i < users.length; i++) {
			System.out.printf("[%d] %s(%s)\n",i,users[i].getName(),users[i].getPayNo());
		}
	...
	public void checkOut() {
		...
		System.out.println("========================================");
		System.out.println("결제 방법 : "+users[selUser].getPayNo());
